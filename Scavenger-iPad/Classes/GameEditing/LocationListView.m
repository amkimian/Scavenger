...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *CellIdentifier = @"LocationIdentifer";
	...
	LocationObject *location = (LocationObject *) [[game.locations allObjects] objectAtIndex:indexPath.row];
    
    UILabel *nameLabel = (UILabel *) [cell viewWithTag:1];
	nameLabel.text = location.name;
	UILabel *typeLabel = (UILabel *) [cell viewWithTag:2];
	typeLabel.text - @"Hello";
    
	// Where is the mapView?
