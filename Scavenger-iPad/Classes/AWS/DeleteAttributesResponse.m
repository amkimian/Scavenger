...
@implementation DeleteAttributesResponse
...
- (void)parserDidEndDocument:(NSXMLParser *)parser
{
	...
	//
	if ([self.delegate respondsToSelector:@selector(deleteAttributesParseComplete)]) 
	{		
		[self.delegate deleteAttributesParseComplete];
    }	
}
