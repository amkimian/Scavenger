...
- (void)viewDidLoad {
	...
	NSArray *array = [[NSArray alloc] initWithObjects:addButton,flexibleButton,doneButton, nil];	
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	GameRouteObject *gRoute = [[game.gameRoutes allObjects] objectAtIndex:indexPath.row];
	cell.textLabel.text = gRoute.name;
